        ...
        {cart.length === 0 ? (
          ...
          <div className="flex flex-col gap-6">
            ...
            {cart.map((el, index) => (
              <div
                key={el.documentId}
                className="flex flex-col sm:flex-row items-center sm:items-start bg-white rounded-xl shadow-md p-4 gap-4 hover:shadow-lg transition"
              >
                {/* Product Image */}
                ...
                <div className="flex-1 flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="px-3 py-1 bg-gray-200 rounded text-gray-800 font-medium">
                      {el.qty}
                    </span>
                    <button
            ...
            {/* Checkout Button */}
            <button className="w-full sm:w-1/3 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary/90 transition self-end"
